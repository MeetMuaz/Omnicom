                    ...
                    <div className='flex justify-between flex-col w-full min-h-screen p-6 lg:p-16 xl:p-20'>
                        ...
                        >
                            <div className='space-y-7 mt-12'>
                                ...
                                <PasswordField register={register} errors={errors} label="New Password" placeholder="New Password*"/>
                                <ConfirmPasswordField register={register} errors={errors} password={password} confirmPassword={confirmPassword}/>
